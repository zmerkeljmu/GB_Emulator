...
int main(int, char**)
{
...
#endif
    {
        ...
        {
            ImGui::Begin("Gameboy");
            ImGui::Text("Game: %s", title);

            ImGui::Text("A: %d", cpu->reg_a);
            ImGui::Text("B: %d", cpu->reg_b);
            ImGui::Text("C: %d", cpu->reg_c);
            ImGui::Text("D: %d", cpu->reg_d);
            ImGui::Text("E: %d", cpu->reg_e);
            ImGui::Text("F: %d", cpu->reg_f);
            ImGui::Text("H: %d", cpu->reg_h);
            ImGui::Text("L: %d", cpu->reg_l);
